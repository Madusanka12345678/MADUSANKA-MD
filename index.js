...
console.log("CONNECTING ༺ ALONE X MD ꙰༻ BOT💮...");
...
console.log('༺ ALONE X MD ꙰༻ CONNECTED TO WHATSAPP ENJOY ✅')

let up = `
*[ •  ༺ ALONE X MD ꙰༻-V1 • ]*
*╭┈───────────────•*
*│ ◦*🧑‍💻 *[ ༺ ALONE X MD ꙰༻ CHANEL ]*
*│ ◈ https://whatsapp.com/channel/0029Vb7p3UCCHDyocfEGm23f*
*│*
*│  ◦*👨‍👦‍👦 *[ WHATSAPP GROUP ]* 
*│ ◈ https://chat.whatsapp.com/JgDQWyoBzQqDr99jPpFRn6*
*│*
*│ ༺ ALONE X MD ꙰༻ බොට් සාදා ගත් ඔබට බොහොම ස්තූතියි 🩷* 
*V2 Cooming Zoon ! 🖤*
*│*
*│*
*╰┈───────────────•*
...
*PREFIX: [.]*
*•────────────•⟢*
> © 🔴ᴘᴏᴡᴇʀᴅ ʙʏ ༺ ALONE X MD ꙰༻ / ༺ ALONE X MD ꙰༻🍃
*•────────────•⟢*
...
app.get("/", (req, res) => {
res.send("HEY, ༺ ALONE X MD ꙰༻ STARTED ✅");
});
